...
namespace MondrianMegane
{
    public class MondrianFilter : MonoBehaviour
    {
        [SerializeField]
        ...
        public Texture2D filterExec(Texture2D srcTex)
        {
            Texture2D outputTex = new Texture2D(srcTex.width, srcTex.height, TextureFormat.RGBA32, false);
            ...
            Graphics.CopyTexture(dstTexture, outputTex);
        ...
        public void makeMonds(Mat srcMat, Mat dstMat)
        {
            myRects.Clear();
        ...
        public void makeMozike2(Mat material)
        {
        ...
        public void pentatomization(Mat material)
        {
